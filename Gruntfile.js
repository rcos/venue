// Generated on 2015-12-19 using generator-angular-fullstack 3.1.0
'use strict';
    ...
    ngconstant: {
      options: {
        ...
        constants: {
          ...
          LOCAL_LOGIN_ENABLED: process.env.LOCAL_LOGIN != "no",
          DEBUG_LOGIN_ENABLED: process.env.DEBUG_LOGIN != "no"
        }
      },
      build: {}
    },
